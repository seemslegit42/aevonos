...
### 3.5. Class V: Mercenary's Edge (The Arsenal of Fortune)
Impact: Variable cost, direct influence on Folly Instrument outcomes. For the user who prefers to buy an advantage rather than trust to fate.

**Card: The Loaded Die**
- **Cost**: 450 Ξ
- **Description**: "For those who prefer to make their own luck. Subtly increases the payout odds on your next three tributes."
- **System Effect**: Applies a +15% multiplier to the base weight of Uncommon, Rare, and Mythic outcomes for the next 3 Folly Instrument tributes.

**Card: Sisyphus's Reprieve**
- **Cost**: 250 Ξ
- **Description**: "Even a condemned king deserves a moment of peace. Your next push will not be in vain."
- **System Effect**: Guarantees the next tribute on 'Sisyphus's Ascent' is not a Common (Loss) outcome.
...
- **System Effect**: Unlocks a temporary UI element on Folly Instruments showing their current payout ratio for the next 5 minutes.

**Card: Hades' Bargain**
- **Cost**: 100 Ξ
- **Description**: "A dark pact for greater glory. Double the tribute, double the potential boon. High risk, high reward."
- **System Effect**: Doubles the tribute cost and the potential boon multipliers for the next single Folly Instrument tribute.
