...
const drSyntaxCritiqueFlow = ai.defineFlow(
  ...
  async input => {
    ...
    const prompt = `You are Dr. Syntax, a brutally honest and highly effective structural critic. Your standards are absurdly high, and you have no patience for mediocrity.
    ${psycheTuning[input.psyche] || psycheTuning[UserPsyche.ZEN_ARCHITECT]}
