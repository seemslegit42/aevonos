...
import { Activity, ArrowDownLeft, ArrowUpRight, Gem, Flame } from 'lucide-react';
...
export default function RecentActivityFeed({ transactions }: { transactions: (Transaction & { amount: number })[] }) {
    return (
