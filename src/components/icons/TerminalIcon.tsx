...
export const TerminalIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
    ...
    <path d="M25 35 L45 50 L25 65" stroke="hsl(var(--foreground))" strokeWidth="3" opacity="0.9" fill="none" />
    <path d="M50 65 H75" stroke="hsl(var(--foreground))" strokeWidth="3" opacity="0.9" fill="none" />
  </svg>
);
