...
export default function ContactCard({ contact }: ContactCardProps) {
  ...
  const handleEdit = () => {
    const newName = prompt(`Enter new first name for ${contact.firstName}:`, contact.firstName || '');
    if (newName) {
        handleCommandSubmit(`update contact with id ${contact.id} to set first name to ${newName}`);
    }
  };
