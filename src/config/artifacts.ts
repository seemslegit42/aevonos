...
export const artifactManifests: ArtifactManifest[] = [
  ...
  },
  {
    ...
    description: 'A standalone, sovereign Security Ritual Engine that integrates with ΛΞVON OS via a high-privilege API. Forge and enforce arcane security policies across your entire digital empire.',
    creditCost: 999999,
    priceModel: 'one-time',
    imageUrl: 'https://placehold.co/600x400.png',
