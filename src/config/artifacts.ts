...
export const artifactManifests: ArtifactManifest[] = [
  ...
  },
  {
    ...
    type: 'MICRO_APP',
    name: 'Reno Mode™',
    author: 'Redemption Arc Detailing',
    description: "A chaotic-good lifestyle utility to lovingly roast and rehabilitate your messy car. Get a flirty, brutally honest assessment and detailing recommendations from a crew of outrageous 'Filthmatch™' specialists.",
    creditCost: 100,
    priceModel: 'one-time',
    imageUrl: 'https://placehold.co/600x400.png',
    imageHint: 'car wash soap neon',
    defaultSize: { width: 400, height: 600 },
    permissionsRequired: [],
    isFeatured: true,
  },
