...
export const artifactManifests: ArtifactManifest[] = [
  ...
  },
  {
    ...
    description: "You glorious disaster… let’s get you back to your seductive sparkle. Lovingly roast and rehabilitate your messy car.",
    creditCost: 100,
    priceModel: 'one-time',
    imageUrl: 'https://placehold.co/600x400.png',
  ...
  },
  {
    ...
    description: 'The Martyr of Mayhem Micro-App. Selling drugs, f***ing friends, breaking hearts—and still somehow surviving your shit.',
    creditCost: 69,
    priceModel: 'one-time',
    imageUrl: 'https://placehold.co/600x400.png',
