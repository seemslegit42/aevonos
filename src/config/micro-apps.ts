...
export const microAppManifests: MicroAppManifest[] = [
  ...
  },
  {
    ...
    name: 'Top-Up Credits',
    author: 'ΛΞVON OS',
    description: 'Add credits to your workspace via e-Transfer.',
    creditCost: 0,
    priceModel: 'included',
    imageUrl: 'https://placehold.co/600x400.png',
    imageHint: 'credits money plus',
  ...
  },
  {
    ...
    author: 'WSB Degenerates',
    description: 'Get unhinged, extremely bullish, and financially irresponsible advice from the Stonks Bot. To the moon!',
    creditCost: 42,
    priceModel: 'one-time',
    imageUrl: 'https://placehold.co/600x400.png',
    imageHint: 'diamond rocket money',
    defaultSize: { width: 320, height: 400 },
    permissionsRequired: ['integration:alpha_vantage'],
