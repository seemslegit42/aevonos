...
export const microAppManifests: MicroAppManifest[] = [
  ...
  },
  {
    ...
    defaultSize: { width: 360, height: 520 },
    permissionsRequired: ['write:billing'],
    routingPath: '/merchant-of-cabbage',
    contextAwareCapabilities: ['tribute_hook'],
    isFeatured: true,
  },
  {
  ...
  },
  {
    ...
    defaultSize: { width: 400, height: 600 },
    permissionsRequired: [],
    routingPath: '/reno-mode',
    contextAwareCapabilities: ['image_upload_hook', 'location_services'],
    isFeatured: true,
  },
  {
    id: 'patrickt-app',
    ...
    permissionsRequired: [],
    routingPath: '/patrickt-app',
    contextAwareCapabilities: ['drama_meter_hook'],
    isFeatured: true,
  },
  {
    id: 'dr-syntax',
